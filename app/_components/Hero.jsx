...
<footer className="bg-white">
  <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div className="text-center">
      <h2 className="text-3xl font-extrabold text-gray-900 sm:text-5xl">Track your Expenses</h2>

      <p className="mx-auto mt-4 max-w-sm text-gray-500">
        Organise your expenses and make better financial decisions with Fintrack
      </p>
      ...
      <ul className="mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end">
        <li>
          ...
          >
            ...
            <Linkedin className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"/>
